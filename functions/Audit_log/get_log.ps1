<#
	...
	===========================================================================
	 ...
	 Filename: audit_log.ps1
	 Tested on V10.2
	===========================================================================
	.DESCRIPTION
		This script is an example on how to retrieve a audit log from a Keyfactor Command Instance.
...
function get-auditlog($query)
{
	...
	$url = $commandapiurl + "Audit?pq.queryString=" + $query
