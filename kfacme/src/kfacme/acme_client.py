...
class AcmeClient:
    ...
    def post(self, endpoint: str, body: dict, apitype: str):
        headers = self._create_auth_headers(apitype)
        url = self._build_url(endpoint, apitype)
    ...
    def claim_post(self, body, apitype: str = None):
    ...
    def admin_accounts_id_put(self, id:str = None, apitype: str = None):
        return self.put(f"Admin/Accounts/{id}", apitype)

    def admin_accounts_get(self, apitype: str = None):
        return self.get(f"Admin/Accounts/List", apitype)

    def admin_accounts_revoke_post(self, acount_id:str = None, deleteKey:bool = False, apitype: str = None):
        ...
        return self.get(url, apitype)

    def app_settings_get(self, apitype: str = None):
        return self.get(f"AppSettings", apitype)

    def app_settings_put(self, id:str, value, apitype: str = None):
